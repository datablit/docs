export const metadata = {
  title: 'Getting Started with Datablit',
  description: 'A high-level introduction to the Datablit Platform. Learn what Datablit does, how it works, and get started with event tracking, rules, signals, and experiments.',
  alternates: {
    canonical: 'https://docs.datablit.com/docs/getting-started',
  },
  openGraph: {
    title: 'Getting Started with Datablit',
    description: 'A high-level introduction to the Datablit Platform. Learn what Datablit does, how it works, and get started with event tracking, rules, signals, and experiments.',
    url: 'https://docs.datablit.com/docs/getting-started',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Getting Started with Datablit',
      },
    ],
  },
  twitter: {
...
Deploy enterprise grade SDKs to collect events and its associated properties from all of your websites, apps(eg. android, ios), third party tools(eg. facebook lead ads) and complement client-side tracking with events from your backend (eg. go, java, python etc).
...
Imagine you are coming up with a creative business strategy, and executing this could take weeks or months. By the time you execute, the peak moment has likely passed. Also managing and deploying various data pipelines for a diverse set of conditions can cost time and money.
...
email: contact@datablit.com
[Check out how to get started with Datablit](/docs/data-ingestion)
