...
A context refers to a portion of metadata automatically attached to a datapoint when it's sent by the SDK.

## Properties

Properties are extra pieces of information you can tie to events you track. They can be anything that will be useful for your business. Datablit recommends attaching properties to the event and use that to create rules and signals.
