export const metadata = {
  "title": "Logical Expressions Guide",
  "description": "Learn how to create logical expressions in Datablit using the Expr language. Combine event fields, signals, and operators to create boolean conditions for rules and filters.",
  "alternates": {
    "canonical": "https://docs.datablit.com/docs/rule-signal/logical-expression"
  },
  "openGraph": {
    "title": "Logical Expressions Guide",
    "description": "Learn how to create logical expressions in Datablit using the Expr language. Combine event fields, signals, and operators to create boolean conditions for rules and filters.",
    "url": "https://docs.datablit.com/docs/rule-signal/logical-expression",
