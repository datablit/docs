export const metadata = {
  ...
  "description": "Step-by-step guide to create rules in Datablit. Learn how to configure rule properties, set conditions, and trigger real-time actions based on user behavior.",
  "alternates": {
    "canonical": "https://docs.datablit.com/docs/rule-signal/create-rule"
  },
  "openGraph": {
    "title": "How to Create a Rule",
    "description": "Step-by-step guide to create rules in Datablit. Learn how to configure rule properties, set conditions, and trigger real-time actions based on user behavior.",
    "url": "https://docs.datablit.com/docs/rule-signal/create-rule",
