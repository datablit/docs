export const metadata = {
  ...
  "description": "Step-by-step guide to create signals in Datablit. Learn how to configure aggregation metrics, set entity IDs, and use signals in rules.",
  "alternates": {
    "canonical": "https://docs.datablit.com/docs/rule-signal/create-signal"
  },
  "openGraph": {
    "title": "How to Create a Signal",
    "description": "Step-by-step guide to create signals in Datablit. Learn how to configure aggregation metrics, set entity IDs, and use signals in rules.",
    "url": "https://docs.datablit.com/docs/rule-signal/create-signal",
...
<Table
  ...
  data={[
    ...
    [
      ...
      "No",
      <>
        Aggregation Field (always in snake_case) used for sum aggregation
        types. See{" "}
        <a
