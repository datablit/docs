export const metadata = {
  ...
  "description": "Integrate Datablit JavaScript SDK for web applications. Track events, identify users, evaluate rules, and run experiments. Complete installation and usage guide.",
  "alternates": {
    "canonical": "https://docs.datablit.com/docs/datablit-sources/js"
  },
  "openGraph": {
    "title": "JavaScript SDK Integration",
    "description": "Integrate Datablit JavaScript SDK for web applications. Track events, identify users, evaluate rules, and run experiments. Complete installation and usage guide.",
    "url": "https://docs.datablit.com/docs/datablit-sources/js",
    ...
    "images": [
      {
        ...
        "width": 1200,
        "height": 630,
        "alt": "JavaScript SDK Integration"
      }
    ]
  },
  "twitter": {
