export const metadata = {
  ...
  "description": "Integrate Datablit Kotlin SDK for Android applications. Lightweight analytics library for event tracking, user identification, rule evaluation, and experiments.",
  "alternates": {
    "canonical": "https://docs.datablit.com/docs/datablit-sources/kotlin"
  },
  "openGraph": {
    "title": "Kotlin SDK for Android",
    "description": "Integrate Datablit Kotlin SDK for Android applications. Lightweight analytics library for event tracking, user identification, rule evaluation, and experiments.",
    "url": "https://docs.datablit.com/docs/datablit-sources/kotlin",
