export const metadata = {
  ...
  "description": "Learn how to integrate Facebook Lead Ads with Datablit to capture and process leads automatically. Step-by-step guide with webhook configuration and CRM setup.",
  "alternates": {
    "canonical": "https://docs.datablit.com/docs/datablit-sources/facebook-lead-ads"
  },
  "openGraph": {
    "title": "Facebook Lead Ads Integration",
    "description": "Learn how to integrate Facebook Lead Ads with Datablit to capture and process leads automatically. Step-by-step guide with webhook configuration and CRM setup.",
    "url": "https://docs.datablit.com/docs/datablit-sources/facebook-lead-ads",
    ...
    "images": [
      {
        ...
        "width": 1200,
        "height": 630,
        "alt": "Facebook Lead Ads Integration"
      }
    ]
  },
  "twitter": {
