...
Signals are data detectives of your product turning raw data into something meaningful. They are custom metrics that you continuously track to trigger actions based on customer data.
...
1. Number of orders in the last 24 hours
2. Average order value per customer
3. Number of orders cancelled in the last 12 hours
